...
if(!class_exists('pinterest_master_admin_settings_wide')){
	require_once( WP_PLUGIN_DIR . '/pinterest-master/includes/pinterest-master-admin-settings-wide-table.php');
}
...
if(!class_exists('pinterest_master_admin_settings_wide_table_options')){
	require_once( WP_PLUGIN_DIR . '/pinterest-master/includes/pinterest-master-admin-settings-wide-table-options.php');
}
//Prepare Table of elements
